...
-- -----------------------------------------------------
-- Table `bdyon`.`conteudo`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bdyon`.`conteudo` ;

CREATE TABLE IF NOT EXISTS `bdyon`.`conteudo` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `id_parente` INT NOT NULL,
  `data_alteracao` DATETIME NULL,
  `tipo` INT NOT NULL,
  `info` TEXT NOT NULL,
  `tipo_parente` INT NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
START TRANSACTION;
USE `bdyon`;
INSERT INTO `bdyon`.`evento` (`id`, `id_usuario`, `nome`, `data_inicio`, `data_fim`, `data_criacao`, `max_venda`, `status`, `id_instancia`, `local`, `descricao`, `flag_hospedagem`, `flag_compras`, `flag_grupos`, `num_visitas`, `url`) VALUES (1, 1, 'Evento Testes', '2017-10-22 22:22', NULL, '2016-09-15 15:15', DEFAULT, 1, 1, NULL, NULL, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT);
...
-- -----------------------------------------------------
-- Data for table `bdyon`.`hotsite`
-- -----------------------------------------------------
START TRANSACTION;
USE `bdyon`;
INSERT INTO `bdyon`.`hotsite` (`id`, `id_evento`, `status`, `info`, `data_alteracao`) VALUES (1, 1, 1, DEFAULT, NULL);

COMMIT;


-- -----------------------------------------------------
-- Data for table `bdyon`.`pagina`
-- -----------------------------------------------------
START TRANSACTION;
USE `bdyon`;
INSERT INTO `bdyon`.`pagina` (`id`, `id_hotsite`, `tipo`, `data_alteracao`, `info`) VALUES (1, 1, 1, NULL, DEFAULT);

COMMIT;


-- -----------------------------------------------------
-- Data for table `bdyon`.`bloco`
-- -----------------------------------------------------
START TRANSACTION;
USE `bdyon`;
INSERT INTO `bdyon`.`bloco` (`id`, `id_pagina`, `data_alteracao`, `weight`, `width`, `float`, `background_image`, `background_color`, `background_image_repeat`) VALUES (1, 1, NULL, 100, 100, 0, NULL, '', 0);

COMMIT;


-- -----------------------------------------------------
-- Data for table `bdyon`.`conteudo`
-- -----------------------------------------------------
START TRANSACTION;
USE `bdyon`;
INSERT INTO `bdyon`.`conteudo` (`id`, `id_parente`, `data_alteracao`, `tipo`, `info`, `tipo_parente`) VALUES (1, 1, NULL, 5, DEFAULT, 1);
INSERT INTO `bdyon`.`conteudo` (`id`, `id_parente`, `data_alteracao`, `tipo`, `info`, `tipo_parente`) VALUES (2, 1, NULL, 6, DEFAULT, 5);
INSERT INTO `bdyon`.`conteudo` (`id`, `id_parente`, `data_alteracao`, `tipo`, `info`, `tipo_parente`) VALUES (3, 1, NULL, 6, DEFAULT, 5);
