...
CREATE TABLE IF NOT EXISTS `bdyon`.`pagina` (
  `id` INT NOT NULL,
  `hotsite_id` INT NOT NULL,
  `tipo` INT NOT NULL,
  `data_alteracao` DATETIME NULL,
  `info` TEXT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_pagina_hotsite1_idx` (`hotsite_id` ASC),
  CONSTRAINT `fk_pagina_hotsite1`
    FOREIGN KEY (`hotsite_id`)
...
CREATE TABLE IF NOT EXISTS `bdyon`.`bloco` (
  ...
  `info` TEXT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_bloco_pagina1_idx` (`pagina_id` ASC),
...
CREATE TABLE IF NOT EXISTS `bdyon`.`caixa` (
  ...
  `info` TEXT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_caixa_bloco1_idx` (`bloco_id` ASC),
